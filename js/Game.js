class Game {
  ...
  showFuel(){
    push();
    image(fuelImage, width/2, height - player.positionY - 350, 20, 20);
    fill("white");
    rect(width/2 + 50,  height - player.positionY - 350, 185, 20);
    fill("gold");
    rect(width/2 + 50,  height - player.positionY - 350, player.fuel, 20);
    pop();
  ...
  showLife(){
    push();
    image(lifeImage, width/2, height - player.positionY - 300, 20, 20);
    fill("white");
    rect(width/2 + 50,  height - player.positionY - 300, 185, 20);
    fill("tomato");
    rect(width/2 + 50,  height - player.positionY - 300, player.life, 20);
    pop();
  }
  ...
  showRank(){
    ...
    swal({
      title: `Incrivel! ${"\n"} ${player.rank}º lugar!`,
      text: `Voce alcançou a linha de chegada! 😏`,
      imageUrl: "https://images.emojiterra.com/google/android-11/512px/1f44d.png",
      imageSize: "100x100",
